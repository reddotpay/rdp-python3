...
RUN source /etc/profile; pip install virtualenv; pip install autopep8; pip install pylint; pip install coverage; pip install sphinx; pip install sphinx-rtd-theme; pip install pandas; pip install boto3; pip install py4j==0.10.4
